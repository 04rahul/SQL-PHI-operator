...
f = [['0_avg_quant'], ['1_avg_quant', '1_sum_quant', '1_count_quant', '1_max_quant'], []]
...
s = ['cust', '0_avg_quant', '1_avg_quant', '1_sum_quant', '1_count_quant', '1_max_quant']
# n = 2
n = 1
# such_that_conditions = [[],['cust = cust and month = month'],['cust != cust and month != month']]
such_that_conditions = [[], ['cust=cust and state = NY']]

...
f = [['0_avg_quant'], ['1_avg_quant'], ['2_avg_quant'], ['3_count_quant']]
...
s = ['prod', 'month', '3_count_quant']
# n = 2
n = 3
# such_that_conditions = [[],['cust = cust and month = month'],['cust != cust and month != month']]
such_that_conditions = [[], ['prod = prod and month = month - 1'], ['prod = prod and month = month + 1'], ['prod = prod and month = month and quant > 1_avg_quant and quant > 2_avg_quant']]
